...
* [SIMA model model](https://github.com/IEAWindSystems/IEA-15-240-RWT/wiki/Frequently-Asked-Questions-(FAQ)#is-sima-supported) implemented by SINTEF Ocean, contact [SINTEF](mailto:sima@sintef.no)
